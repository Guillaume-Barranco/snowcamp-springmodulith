package org.snowcamp.university.springmodulith.order.stock.configuration;

import org.snowcamp.university.springmodulith.order.OrderCompleteEvent;
import org.snowcamp.university.springmodulith.order.stock.domain.StockNotifier;
